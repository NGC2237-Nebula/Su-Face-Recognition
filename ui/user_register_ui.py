...
class RegisterMsgUi(object):
    def setupUi(self, Dialog):
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(0, 330, 341, 41))
        ...
        self.register_msg_2.setMinimumSize(QtCore.QSize(50, 0))
        self.register_msg_2.setObjectName("register_msg_2")
        self.gridLayout_1.addWidget(self.register_msg_2, 2, 0, 1, 1)
        # 年龄 标题
        self.register_msg_3 = QtWidgets.QPushButton(self.gridLayoutWidget_1)
        self.register_msg_3.setObjectName("register_msg_3")
        self.gridLayout_1.addWidget(self.register_msg_3, 3, 0, 1, 1)
        # 性别 标题
        self.register_msg_4 = QtWidgets.QPushButton(self.gridLayoutWidget_1)
        self.register_msg_4.setObjectName("register_msg_4")
        self.gridLayout_1.addWidget(self.register_msg_4, 4, 0, 1, 1)
        # 更多信息 标题
        self.register_msg_5 = QtWidgets.QPushButton(self.gridLayoutWidget_1)
        self.register_msg_5.setObjectName("register_msg_5")
        self.gridLayout_1.addWidget(self.register_msg_5, 5, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.register_title.setText(_translate("Dialog", "  注册  "))
        self.register_msg_1.setText(_translate("Dialog", "  姓名  "))
        self.register_msg_2.setText(_translate("Dialog", "  密码  "))
        self.register_msg_3.setText(_translate("Dialog", "  年龄  "))
        self.register_msg_4.setText(_translate("Dialog", "  性别  "))
        self.register_msg_5.setText(_translate("Dialog", "  更多信息  "))
        ...
        # ------------------------------------ #
        # 输入栏样式
        lineText = [self.password_lineEdit,self.age_lineEdit, self.sex_lineEdit, self.name_lineEdit, self.more_lineEdit]
        line = 0
