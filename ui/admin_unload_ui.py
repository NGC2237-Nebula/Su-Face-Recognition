...
class AdminUnloadUi(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.register_title.setText(_translate("Dialog", "用户解锁"))
        self.register_msg_1.setText(_translate("Dialog", "  账号  "))
        self.register_msg_2.setText(_translate("Dialog", "  密码  "))

        self.confirm_button.setText(_translate("Dialog", "解锁"))
        ...
        # ------------------------------------ #
        spin_icon = qtawesome.icon('fa5s.sign-in-alt', color='black')
        ...
        self.name_lineEdit.setPlaceholderText("请输入用户名")
        self.password_lineEdit.setPlaceholderText("请输入用户密码")
